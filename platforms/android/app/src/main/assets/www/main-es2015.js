...
const routes = [
    ...
    {
        path: 'webrtcview',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-web-rtcview-web-rtcview-module */ "pages-web-rtcview-web-rtcview-module").then(__webpack_require__.bind(null, /*! ./pages/web-rtcview/web-rtcview.module */ "./src/app/pages/web-rtcview/web-rtcview.module.ts")).then(m => m.WebRTCViewModule)
    },
];
...
module.exports = __webpack_require__(/*! D:\CXproject\myFirstAppa\src\main.ts */"./src/main.ts");
